...
public class CraftMenuInventory1_10_R1 extends CraftInventoryCustom implements MenuInventory {

    private final MenuData data;

    public CraftMenuInventory1_10_R1(InventoryHolder owner, int size, String title, MenuData data) {
