package team.unnamed.gui.v1_13_R2;
...
public class CraftMenuInventory1_13_R2 extends CraftInventoryCustom implements MenuInventory {

    private final MenuData data;

    public CraftMenuInventory1_13_R2(InventoryHolder owner, int size, String title, MenuData data) {
