package team.unnamed.gui.v1_14_R1;
...
public class CraftMenuInventory1_14_R1 extends CraftInventoryCustom implements MenuInventory {

    private final MenuData data;

    public CraftMenuInventory1_14_R1(InventoryHolder owner, int size, String title, MenuData data) {
