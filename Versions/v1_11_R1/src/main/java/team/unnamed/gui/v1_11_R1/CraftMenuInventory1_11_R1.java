...
public class CraftMenuInventory1_11_R1 extends CraftInventoryCustom implements MenuInventory {

    private final MenuData data;

    public CraftMenuInventory1_11_R1(InventoryHolder owner, int size, String title, MenuData data) {
