...
public class CraftGUIInventory1_9_R2 implements GUIInventory, InventoryHolder, Inventory {

  private final Inventory raw;
  private final GUIData data;

  public CraftGUIInventory1_9_R2(InventoryHolder owner, GUIData data) {
    this.data = data;
