...
public class CraftGUIInventory1_12_R1 implements GUIInventory, InventoryHolder, Inventory {

    private final Inventory raw;
    private final GUIData data;

    public CraftGUIInventory1_12_R1(InventoryHolder owner, GUIData data) {
        this.data = data;
